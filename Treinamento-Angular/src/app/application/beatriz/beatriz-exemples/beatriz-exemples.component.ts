...
@Component({
  selector: "app-beatriz-exemples",
  templateUrl: "./beatriz-exemples.component.html",
  styleUrls: ["./beatriz-exemples.component.scss"],
})
export class BeatrizExemplesComponent implements OnInit {
  page;
  table = {
    thead: [],
    tbody: [],
